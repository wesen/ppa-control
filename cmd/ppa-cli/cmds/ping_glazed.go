...
// PingGlazedCommand handles PPA ping messages with glazed framework support.
// It supports classic (human-readable) and structured Glazed output.
type PingGlazedCommand struct {
	*cmds.CommandDescription
}

// Run implements the BareCommand interface for classic text output
func (c *PingGlazedCommand) Run(ctx context.Context, parsedLayers *layers.ParsedLayers) error {
	// Initialize logging
...
func (c *PingGlazedCommand) RunIntoGlazeProcessor(
	ctx context.Context,
...
// NewPingGlazedCommand creates a new ping command with glazed support
func NewPingGlazedCommand() (*PingGlazedCommand, error) {
	// Get standard layers
	...
	cmdDesc := cmds.NewCommandDescription(
		"ping-glazed",
		cmds.WithShort("Send ping messages to PPA servers with structured output support"),
	...
	return &PingGlazedCommand{
		CommandDescription: cmdDesc,
	}, nil
}

// Ensure interface compliance
var _ cmds.BareCommand = &PingGlazedCommand{}
var _ cmds.GlazeCommand = &PingGlazedCommand{}
