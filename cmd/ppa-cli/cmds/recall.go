...
// RecallCommand handles PPA recall messages with glazed framework support.
...
func (c *RecallCommand) Run(ctx context.Context, parsedLayers *layers.ParsedLayers) error {
	// Initialize logging
...
// NewRecallCommand creates a new recall command with glazed support
...
var _ cmds.BareCommand = &RecallCommand{}
var _ cmds.GlazeCommand = &RecallCommand{}
