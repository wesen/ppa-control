...
// VolumeGlazedCommand handles PPA volume commands with glazed framework support.
// It supports structured output only (implements GlazeCommand interface).
type VolumeGlazedCommand struct {
...
func (c *VolumeGlazedCommand) RunIntoGlazeProcessor(
	ctx context.Context,
...
// NewVolumeGlazedCommand creates a new volume command with glazed support
func NewVolumeGlazedCommand() (*VolumeGlazedCommand, error) {
	// Get standard layers
	...
	return &VolumeGlazedCommand{
		CommandDescription: cmdDesc,
	}, nil
}

// Ensure interface compliance
var _ cmds.GlazeCommand = &VolumeGlazedCommand{}
